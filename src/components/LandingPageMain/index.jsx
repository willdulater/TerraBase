  ...
  <div style={styles.backgroundDecorations2}></div>
        ...
        <div
          style={{
            ...
            ...(hoveredCard === "profile" ? styles.cardHover : {}), // Apply hover effect
          }}
        ...
        >
          <div style={styles.iconContainer}>
            <img src="profile-database-icon.svg" alt="Profile Icon" style={styles.icon} />
          </div>
          <h3 style={styles.cardTitle}>Profiles</h3>
          <p style={styles.cardDescription}>
            View hundreds of past applicants, their stats, and results.
          </p>
        </div>
        ...
        <div
          style={{
            ...styles.card,
            ...styles.cardBlueShadow, // Always apply the blue shadow for "Create"
            ...(hoveredCard === "create" ? styles.cardHover : {}), // Apply hover effect
          }}
        ...
        >
          <div style={styles.iconContainer}>
            <img src="ai-create.svg" alt="Create Icon" style={styles.icon} />
          </div>
          <h3 style={styles.cardTitle}>Create</h3>
          <p style={styles.cardDescription}>
            Start drafting your essay from scratch with AI assistance.
          </p>
        </div>
        ...
        <div
          style={{
            ...styles.card,
            ...(hoveredCard === "refine" ? styles.cardSharedHover : {}), // Shared hover style
          }}
          onMouseEnter={() => setHoveredCard("refine")}
          onMouseLeave={() => setHoveredCard(null)}
          onClick={() => {
        ...
        >
          <div style={styles.iconContainer}>
            <img src="ai-refine.svg" alt="Refine Icon" style={styles.icon} />
          </div>
          <h3 style={styles.cardTitle}>Refine</h3>
          <p style={styles.cardDescription}>
            Improve and polish an existing essay for clarity and impact.
          </p>
        </div>
